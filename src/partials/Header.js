            ...
            <ul className="flex flex-grow justify-end flex-wrap items-center">

              {
                user && user.isLoggedIn ? <li>
                  <button onClick={handleLogOut} className="font-medium bg-gray-900 text-white rounded hover:text-red-500 px-5 py-2 flex items-center transition duration-150 ease-in-out">Log out</button>
                 </li> : <li>
              ...
              {
                user && user.isLoggedIn ? <li>
                <Link to="/signup" className="btn-sm text-gray-200 bg-gray-900 hover:bg-gray-800 ml-3 hidden">
                  <span>Sign up</span>
