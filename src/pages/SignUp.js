                ...
                <form onSubmit={handleSubmit}>
                  <div className="flex flex-wrap -mx-3 mb-4">
                    <div className="w-full px-3">
                      ...
                      <input name="name" id="name" type="text" className="form-input w-full text-gray-800" placeholder="Enter your name" onBlur={handleBlur} required />
                    </div>
                  </div>
                  <div className="flex flex-wrap -mx-3 mb-4">
                    <div className="w-full px-3">
                      <label className="block text-gray-800 text-sm font-medium mb-1" htmlFor="email">Email <span className="text-red-600">*</span></label>
                      <input name="email" id="email" type="email" className="form-input w-full text-gray-800" placeholder="Enter your email address" onBlur={handleBlur} required />
                    </div>
                  </div>
                  ...
                  <div className="flex flex-wrap -mx-3 mb-4">
                    <div className="w-full px-3">
                      ...
                      <input name="date" id="date" type="date" className="form-input w-full text-gray-800" onBlur={handleBlur} required />
                    </div>
                  </div>
                  ...
                  <div className="flex flex-wrap -mx-3 mb-4">
                    <div className="w-full px-3">
                      ...
                      <input name="profession" id="profession" type="profession" className="form-input w-full text-gray-800" placeholder="Enter your Profession" onBlur={handleBlur} required />
                    </div>
                  </div>
                  ...
                  <div className="flex flex-wrap -mx-3 mb-4">
                    <div className="w-full px-3">
                      ...
                      <input name="password" id="password" type="password" className="form-input w-full text-gray-800" placeholder="Enter your password" onBlur={handleBlur} required />
                    </div>
                  </div>
                  <div className="flex flex-wrap -mx-3 mt-6">
                    <div className="w-full px-3">
                      <input className="h-10 text-white bg-blue-600 hover:bg-blue-700 w-full" type="submit" value="Sign up" />
                    </div>
                  </div>
